...
insert into Cities (Id, Name, CountryId) values (1, 'Bursa', 1)
...
insert into UserDetails (Id, EMail, CountryId, CityId, Address) values (1, 'etk@kara.com', 1, 1, 'Nilufer')
insert into UserDetails (Id, EMail, CountryId, CityId, Address) values (2, 'wer@kara.com', 2, 4, 'Manhattan')
set identity_insert UserDetails off
go
set identity_insert Users on
insert into Users (Id, UserName, Password, Active, RoleId, UserDetailId) values (1, 'etk', 'etk', 1, 1, 1)
insert into Users (Id, UserName, Password, Active, RoleId, UserDetailId) values (2, 'wer', 'wer', 1, 2, 2)
